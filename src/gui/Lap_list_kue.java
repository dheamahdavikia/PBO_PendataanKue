 ...
 * @author User
 */
public class Lap_list_kue extends javax.swing.JFrame {
JasperReport jasperReport1;
 ...
 List<entitas.Entitas_Admin> listTu = new ArrayList<>();
    ...
    private void initComponents() {
        ...
        setTitle("Cetak Laporan Data Kue");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jRadioButton1.isSelected()) {
           try{
            ...
            File file = new File("src/laporan/LaporanDataKue.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lap_list_kue.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
